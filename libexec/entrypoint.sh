...
STRING_KEYS="DB_NAME DB_USER DB_HOST DB_CHARSET DB_COLLATE DB_PASSWORD"
TO_GENERATE_KEYS="AUTH_KEY SECURE_AUTH_KEY LOGGED_IN_KEY NONCE_KEY AUTH_SALT SECURE_AUTH_SALT LOGGED_IN_SALT NONCE_SALT"
